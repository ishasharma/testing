...
public class CurrentMonth implements Serializable, CommonEntityInterface, Comparator<CurrentMonth> {
    ...
    @Id
    @GeneratedValue(generator = "ast_currentmonth_m_seq")
    @SequenceGenerator(name = "ast_currentmonth_m_seq", sequenceName = "AST_CURRENTMONTH_M_seq", allocationSize = 1)
    @Column(name = "monthid")
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.salesboundedcontext.sales.CurrentMonth other = (sales.app.shared.salesboundedcontext.sales.CurrentMonth) obj;
            if (monthid == null) {
                return false;
