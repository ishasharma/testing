...
public class SalesData implements Serializable, CommonEntityInterface, Comparator<SalesData> {
    ...
    @Id
    @GeneratedValue(generator = "ast_salesdata_t_seq")
    @SequenceGenerator(name = "ast_salesdata_t_seq", sequenceName = "AST_SALESDATA_T_seq", allocationSize = 1)
    @Column(name = "autoid")
    @JsonProperty("autoid")
    @Min(-2147483648L)
    @Max(2147483647)
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.salesboundedcontext.sales.SalesData other = (sales.app.shared.salesboundedcontext.sales.SalesData) obj;
            if (autoid == null) {
                return false;
