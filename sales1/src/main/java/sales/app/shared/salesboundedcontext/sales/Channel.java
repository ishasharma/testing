...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Channel", complexity = Complexity.LOW)
...
public class Channel implements Serializable, CommonEntityInterface, Comparator<Channel> {
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.salesboundedcontext.sales.Channel other = (sales.app.shared.salesboundedcontext.sales.Channel) obj;
            if (channelId == null) {
                return false;
