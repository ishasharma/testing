...
public class RetailerServiceImpl extends RetailerService {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody Retailer entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<Retailer> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            retailerrepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody Retailer entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<Retailer> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            retailerrepo.update(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> findByDistributorcode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
