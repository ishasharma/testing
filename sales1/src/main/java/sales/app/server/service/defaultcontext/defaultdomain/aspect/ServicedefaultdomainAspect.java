package sales.app.server.service.defaultcontext.defaultdomain.aspect;
...
public class ServicedefaultdomainAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* sales.app.server.service.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.defaultcontext.defaultdomain..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.defaultcontext.defaultdomain..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
