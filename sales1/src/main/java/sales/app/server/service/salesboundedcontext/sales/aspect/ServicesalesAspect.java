package sales.app.server.service.salesboundedcontext.sales.aspect;
...
public class ServicesalesAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
