...
public class SalesDataServiceImpl extends SalesDataService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<sales.app.shared.salesboundedcontext.sales.SalesData> lstsalesdata = salesDatarepo.findAll();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody SalesData entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<SalesData> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            salesDatarepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody SalesData entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<SalesData> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            salesDatarepo.update(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> findByChannelId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<sales.app.shared.salesboundedcontext.sales.SalesData> lstsalesdata = salesDatarepo.findByChannelId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalesdata);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> findByReatilercode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<sales.app.shared.salesboundedcontext.sales.SalesData> lstsalesdata = salesDatarepo.findByReatilercode((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalesdata);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> findByMaterialcode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<sales.app.shared.salesboundedcontext.sales.SalesData> lstsalesdata = salesDatarepo.findByMaterialcode((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalesdata);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> findByBrandcode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<sales.app.shared.salesboundedcontext.sales.SalesData> lstsalesdata = salesDatarepo.findByBrandcode((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalesdata);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> findByCategory(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<sales.app.shared.salesboundedcontext.sales.SalesData> lstsalesdata = salesDatarepo.findByCategory((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalesdata);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            sales.app.shared.salesboundedcontext.sales.SalesData lstsalesdata = salesDatarepo.findById((java.lang.Integer) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsalesdata);
        } catch (org.springframework.transaction.TransactionException e) {
