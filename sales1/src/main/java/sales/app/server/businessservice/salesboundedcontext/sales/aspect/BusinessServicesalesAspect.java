package sales.app.server.businessservice.salesboundedcontext.sales.aspect;
...
public class BusinessServicesalesAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.salesboundedcontext.sales..*(..))")
