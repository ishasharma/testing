package sales.app.server.businessservice.defaultcontext.defaultdomain.aspect;
...
public class BusinessServicedefaultdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.defaultcontext.defaultdomain..*(..))")
