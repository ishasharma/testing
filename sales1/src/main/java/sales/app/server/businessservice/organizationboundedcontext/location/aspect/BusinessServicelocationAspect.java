package sales.app.server.businessservice.organizationboundedcontext.location.aspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.organizationboundedcontext.location..*(..))")
