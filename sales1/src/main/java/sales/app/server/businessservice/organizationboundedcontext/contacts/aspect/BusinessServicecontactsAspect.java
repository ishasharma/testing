package sales.app.server.businessservice.organizationboundedcontext.contacts.aspect;
import sales.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
