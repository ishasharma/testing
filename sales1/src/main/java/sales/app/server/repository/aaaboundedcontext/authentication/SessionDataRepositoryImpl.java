...
import sales.app.shared.aaaboundedcontext.authentication.SessionData;
...
public class SessionDataRepositoryImpl extends SearchInterfaceImpl implements SessionDataRepository<SessionData> {
    ...
    @Transactional
    @Override
    public SessionDataInterface saveSessionData(String userId, String customerId, int dataType, Integer numberValue, String stringValue, String jsonValue, Boolean booleanValue, Timestamp dateTimeValue, String appSessionId, String sessionKey) throws SpartanConstraintViolationException, SpartanPersistenceException {
    ...
    @Transactional
    @Override
    public void update(SessionDataInterface entity) throws SpartanConstraintViolationException, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            sales.app.shared.aaaboundedcontext.authentication.SessionData s = emanager.find(sales.app.shared.aaaboundedcontext.authentication.SessionData.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
