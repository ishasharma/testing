package sales.app.server.repository.organizationboundedcontext.contacts.aspect;
...
public class RepositorycontactsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.contacts..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.contacts..*(..))")
