package sales.app.server.repository.organizationboundedcontext.location.aspect;
...
public class RepositorylocationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.location..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organizationboundedcontext.location..*(..))")
