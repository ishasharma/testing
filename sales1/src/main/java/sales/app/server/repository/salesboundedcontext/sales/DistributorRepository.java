...
public interface DistributorRepository<T> extends SearchInterface {
    ...
    public List<T> findByRegioncode(String regioncode) throws Exception, SpartanPersistenceException;

    public T findById(String distributorcode) throws Exception, SpartanPersistenceException;
}
