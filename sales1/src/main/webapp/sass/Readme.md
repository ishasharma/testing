...
folder are mapped to the application's root namespace, 'Sales1'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Sales1' in the same way
as `"Sales1/sass/src"`.
