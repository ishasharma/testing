 ...
 * 
 */
Ext.define('Sales1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Sales1.view.securityconfig.SecurityConfigController',
			'Sales1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
