 ...
 * 
 */
Ext.define('Sales1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Sales1.view.logalarm.mainscreen.AddLogAlarmController',
			'Sales1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Sales1.view.logalarm.mainscreen.AppAlarmPanel',
