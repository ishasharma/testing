 ...
 * 
 */
Ext.define('Sales1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Sales1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
