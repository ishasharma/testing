...
Ext
		.define(
				'Sales1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Sales1.view.logger.tabs.details.DetailsTab',
							'Sales1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Sales1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Sales1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Sales1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Sales1.view.logger.LogConfigurationTabPanelController',
