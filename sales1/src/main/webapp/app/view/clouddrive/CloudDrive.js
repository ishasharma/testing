Ext.define("Sales1.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Sales1.view.clouddrive.CloudDriveController',
	             'Sales1.view.clouddrive.documentview.DocumentsView',
	             'Sales1.view.clouddrive.drivedetails.DriveDetails',
	             //'Sales1.view.clouddrive.documentview.DocumentListView'
	             ],
