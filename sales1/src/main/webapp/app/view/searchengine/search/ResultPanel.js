Ext
		.define(
				'Sales1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Sales1.view.searchengine.search.SearchEngineMainPanelController','Sales1.view.searchengine.search.PanelHeaderField' ,'Sales1.view.searchengine.search.ReportGridView','Sales1.view.searchengine.search.ReportChartView','Sales1.view.searchengine.search.documentView','Sales1.view.searchengine.search.DouMeanView','Sales1.view.googlemaps.map.MapPanel'],
