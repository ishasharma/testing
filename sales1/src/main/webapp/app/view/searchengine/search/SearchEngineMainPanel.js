Ext.define('Sales1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Sales1.view.searchengine.search.NorthPanel', 'Sales1.view.searchengine.search.SearchResult','Sales1.view.searchengine.search.SearchEngineMainPanelController'],
