...
public class CategoryTestCase extends EntityTestCriteria {
    ...
    private Category createCategory() throws SpartanPersistenceException, SpartanConstraintViolationException {
        Category category = new Category();
        category.setCategory("uMCB8h8coKD8DNMGNykjq7V9UtKUkR7DhHrb3mmAjF84slJzu9");
    ...
    public void test2Update() {
        try {
            ...
            category.setCategory("VbYXmpj7pSJ6Akk31QiJXT1wonCjwCItpZsBYVrkGEMF8pfygl");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "category", "LQl5E1gGjPbAo6dWDpbl2l2ISrUWG4HQLvoHqibMbIsazuiidQWV5tBeQQafnXObL"));
