...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion() throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionDetails("6T0p0eYfRA");
        question.setQuestion("rBI1KM55tWO0HgkJwssQiacx3yldaiHORKaHBou34sT0a4LC7R");
        question.setQuestionIcon("nJtX1EFEBdAl7QQaHUTUCE15DM5ecBHoCXcE6Xv6mTcfN4ZEZ8");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("2riCkaOTmB");
            question.setQuestion("QCDItyhdM53bIEfieElP1mqa8o3Twp2ZAtVnJUWnqMU6lMJ7sl");
            question.setVersionId(1);
            question.setQuestionIcon("gOCVezLbCtvKrpZpg4Q3IZSbNKTN4Sf5f0QOI32rjuAu9VbjFf");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", "n"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "56vkL6Ac1cJDeCSfkejZ7dG7a167qkPXGiTkeDvGAjGOFDNCuSk2kONgymyCXm2Nv"));
