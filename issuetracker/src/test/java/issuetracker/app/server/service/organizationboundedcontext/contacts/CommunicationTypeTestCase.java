...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType() throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        communicationgroup.setCommGroupDescription("wqaSoXuwuUKVRlr8fFXCpIsLQ8B6VtY7srdvzeu9YjnWrugdqY");
        communicationgroup.setCommGroupName("qV27BuhUsqzDHzOSai89GQILAu343NlXuKUP2v5KcbaWdrxw4Q");
        CommunicationGroup CommunicationGroupTest = communicationgroupRepository.save(communicationgroup);
        map.put("CommunicationGroupPrimaryKey", communicationgroup._getPrimarykey());
        CommunicationType communicationtype = new CommunicationType();
        communicationtype.setCommTypeDescription("OybOc9Zx8VibpyeOqbUjCASuF46GvgrGa4p3J9ZwHwsZOo3kEn");
        communicationtype.setCommTypeName("Ba5Ft2aAaDPkRYmgzSBPBUdsum3G9oJTz3W3KZID7amJmWyuRs");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeDescription("LQ1AAVnENFQ227ROFy7N3bR7j4XIQOZ9Lan337IbwNYrjN3U5J");
            communicationtype.setCommTypeName("6QggdqZj7bmj9hCFZosrvKgQG3tsSe0lGJAavDjtogreST8AkR");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "Io0It6b6PJC24m5taf5dgSiRw0MySdQE4JIAuZupVqEvuOUSu0RejAtv49gmaemPWtP6z7p6uW6FKT43B9voHvldLfUJSfcQo17TYY1aaPT4Y2e84dFosDQlt6YynWErR"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
