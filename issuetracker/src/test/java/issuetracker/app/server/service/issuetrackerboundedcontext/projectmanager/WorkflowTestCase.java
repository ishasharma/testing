...
public class WorkflowTestCase extends EntityTestCriteria {
    ...
    private Workflow createWorkflow() throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        workflow.setWorkflowName("SHpSwuFTkjsxypRT0xuyHxW1YEdCoTAgUzVJoAM7CB6JiXPrjA");
    ...
    public void test2Update() {
        try {
            ...
            workflow.setWorkflowName("Y7yX1dBv0YZb4HIbNq35qpYDPRNtE0SfSca9s0aNbNsakddvbC");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "workflowName", "VtrcDqjiKtzRX1FOTy9k23rSyyG1euifZdDtrj68HeEXRANjErEauKA60KvFVvT3o"));
