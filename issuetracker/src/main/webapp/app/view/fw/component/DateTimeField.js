 ...
 */
Ext.define('Issuetracker.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Issuetracker.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Issuetracker.view.fw.component.DateTimePicker(o);
    },
