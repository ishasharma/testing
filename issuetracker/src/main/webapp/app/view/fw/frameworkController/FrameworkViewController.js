Ext.define('Issuetracker.view.fw.frameworkController.FrameworkViewController', {
   ...
   addCommunicationLog: function(response, success, compRef) {
    ...
    onConsoleClick: function() {
         var window = Ext.create('Issuetracker.view.console.ConsoleWindow');
