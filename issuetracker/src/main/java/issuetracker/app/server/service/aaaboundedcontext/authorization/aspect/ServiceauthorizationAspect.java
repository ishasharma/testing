package issuetracker.app.server.service.aaaboundedcontext.authorization.aspect;
...
@Aspect
@Component
public class ServiceauthorizationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.service.aaaboundedcontext.authorization..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.aaaboundedcontext.authorization..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.aaaboundedcontext.authorization..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.aaaboundedcontext.authorization..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.aaaboundedcontext.authorization..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.aaaboundedcontext.authorization..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
