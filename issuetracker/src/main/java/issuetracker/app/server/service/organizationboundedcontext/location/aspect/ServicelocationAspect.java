package issuetracker.app.server.service.organizationboundedcontext.location.aspect;
...
@Aspect
@Component
public class ServicelocationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.service.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.organizationboundedcontext.location..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.organizationboundedcontext.location..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
