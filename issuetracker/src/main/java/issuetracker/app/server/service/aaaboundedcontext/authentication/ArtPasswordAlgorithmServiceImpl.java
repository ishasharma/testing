...
import issuetracker.app.shared.aaaboundedcontext.authentication.ArtPasswordAlgorithm;

import issuetracker.app.server.repository.aaaboundedcontext.authentication.ArtPasswordAlgorithmRepository;
...
public class ArtPasswordAlgorithmServiceImpl extends ArtPasswordAlgorithmService {
	...
	@Override
	public HttpEntity<ResponseBean> save(@RequestBody ArtPasswordAlgorithm entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
		ResponseBean responseBean = new ResponseBean();
	...
	@Override
	public HttpEntity<ResponseBean> save(@RequestBody List<ArtPasswordAlgorithm> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException,
	...
	@Override
	public HttpEntity<ResponseBean> update(@RequestBody ArtPasswordAlgorithm entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
		ResponseBean responseBean = new ResponseBean();
		org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
		try {
	...
	@Override
	public HttpEntity<ResponseBean> update(@RequestBody List<ArtPasswordAlgorithm> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException,
			SpartanTransactionException, Exception {
		ResponseBean responseBean = new ResponseBean();
		org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
		try {
