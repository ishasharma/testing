package issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager.aspect;
import issuetracker.app.server.service.aspect.ServiceAspect;
...
@Aspect
@Component
public class ServiceprojectmanagerAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.service.issuetrackerboundedcontext.projectmanager..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
