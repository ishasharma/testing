package issuetracker.app.server.businessservice.issuetrackerboundedcontext.issuetracker.aspect;
...
@Aspect
@Component
public class BusinessServiceissuetrackerAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.issuetrackerboundedcontext.issuetracker..*(..))")
