package issuetracker.app.server.businessservice.organizationboundedcontext.location.aspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.organizationboundedcontext.location..*(..))")
