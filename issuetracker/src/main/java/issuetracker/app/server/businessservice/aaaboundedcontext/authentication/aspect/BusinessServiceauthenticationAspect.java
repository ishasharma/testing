package issuetracker.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
@Aspect
@Component
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
