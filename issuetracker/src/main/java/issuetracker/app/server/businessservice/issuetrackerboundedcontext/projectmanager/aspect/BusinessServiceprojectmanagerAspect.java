package issuetracker.app.server.businessservice.issuetrackerboundedcontext.projectmanager.aspect;
import issuetracker.app.server.businessservice.aspect.BusinessAspect;
...
@Aspect
@Component
public class BusinessServiceprojectmanagerAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.issuetrackerboundedcontext.projectmanager..*(..))")
