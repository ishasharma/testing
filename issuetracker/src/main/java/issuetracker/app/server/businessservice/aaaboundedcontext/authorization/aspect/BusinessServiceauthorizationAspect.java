package issuetracker.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
@Aspect
@Component
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
