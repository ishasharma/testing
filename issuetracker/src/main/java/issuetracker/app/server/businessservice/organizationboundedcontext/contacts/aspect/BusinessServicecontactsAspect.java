package issuetracker.app.server.businessservice.organizationboundedcontext.contacts.aspect;
...
@Aspect
@Component
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
