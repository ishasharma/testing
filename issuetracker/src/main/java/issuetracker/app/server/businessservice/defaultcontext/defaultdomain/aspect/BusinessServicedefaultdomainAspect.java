package issuetracker.app.server.businessservice.defaultcontext.defaultdomain.aspect;
...
@Aspect
@Component
public class BusinessServicedefaultdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.businessservice.defaultcontext.defaultdomain..*(..))")
