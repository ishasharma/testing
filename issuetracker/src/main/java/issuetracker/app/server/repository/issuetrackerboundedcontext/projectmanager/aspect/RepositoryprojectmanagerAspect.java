package issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager.aspect;
import issuetracker.app.server.repository.aspect.RepositoryAspect;
...
@Aspect
@Component
public class RepositoryprojectmanagerAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.projectmanager..*(..))")
