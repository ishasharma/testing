...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for ProjectAccessRights Master table Entity", complexity = Complexity.LOW)
public interface ProjectAccessRightsRepository<T> extends SearchInterface {
    ...
    public T findById(String projectAccessCode) throws Exception, SpartanPersistenceException;
}
