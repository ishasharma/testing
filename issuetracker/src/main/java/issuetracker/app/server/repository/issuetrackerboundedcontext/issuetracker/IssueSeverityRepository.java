...
public interface IssueSeverityRepository<T> extends SearchInterface {
    ...
    public T findById(String issueSeverityCode) throws Exception, SpartanPersistenceException;
}
