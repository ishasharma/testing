...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for IssueStatus Master table Entity", complexity = Complexity.LOW)
public class IssueStatusRepositoryImpl extends SearchInterfaceImpl implements IssueStatusRepository<IssueStatus> {
    ...
    @Override
    @Transactional
    public List<IssueStatus> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus> query = emanager.createQuery("select u from IssueStatus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public IssueStatus save(IssueStatus entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<IssueStatus> save(List<IssueStatus> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(IssueStatus entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<IssueStatus> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus obj = entity.get(i);
    ...
    @Transactional
    public List<IssueStatus> findByIssueStageCode(String issueStageCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("IssueStatus.findByIssueStageCode");
            query.setParameter("issueStageCode", issueStageCode);
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus> listOfIssueStatus = query.getResultList();
    ...
    @Transactional
    public IssueStatus findById(String issueStatusCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("IssueStatus.findById");
            query.setParameter("issueStatusCode", issueStatusCode);
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus listOfIssueStatus = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueStatus) query.getSingleResult();
            return listOfIssueStatus;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
