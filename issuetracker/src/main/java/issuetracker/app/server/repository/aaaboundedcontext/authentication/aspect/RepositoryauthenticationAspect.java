package issuetracker.app.server.repository.aaaboundedcontext.authentication.aspect;
...
@Aspect
@Component
public class RepositoryauthenticationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.repository.aaaboundedcontext.authentication..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.aaaboundedcontext.authentication..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.aaaboundedcontext.authentication..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.aaaboundedcontext.authentication..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.aaaboundedcontext.authentication..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.aaaboundedcontext.authentication..*(..))")
