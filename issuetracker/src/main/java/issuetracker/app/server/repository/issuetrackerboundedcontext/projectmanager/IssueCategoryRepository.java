...
public interface IssueCategoryRepository<T> extends SearchInterface {
    ...
    public T findById(String issueCategoryCode) throws Exception, SpartanPersistenceException;
}
