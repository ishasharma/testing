...
public interface WorkflowUserRoleRepository<T> extends SearchInterface {
    ...
    public List<T> findByWorkflowId(String workflowId) throws Exception, SpartanPersistenceException;

    public List<T> findByPrjRoleId(String prjRoleId) throws Exception, SpartanPersistenceException;

    public T findById(String workUserRoleId) throws Exception, SpartanPersistenceException;
}
