...
public class ProjectModuleRepositoryImpl extends SearchInterfaceImpl implements ProjectModuleRepository<ProjectModule> {
    ...
    public List<ProjectModule> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule> query = emanager.createQuery("select u from ProjectModule u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<ProjectModule> save(List<ProjectModule> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteModuleUserMapping(List<ModuleUserMapping> moduleusermapping) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ModuleUserMapping _moduleusermapping : moduleusermapping) {
                issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ModuleUserMapping s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ModuleUserMapping.class, _moduleusermapping.getModUserId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public List<ProjectModule> findByProjectId(String projectId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule> listOfProjectModule = query.getResultList();
    ...
    public ProjectModule findById(String moduleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule listOfProjectModule = (issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.ProjectModule) query.getSingleResult();
            return listOfProjectModule;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
