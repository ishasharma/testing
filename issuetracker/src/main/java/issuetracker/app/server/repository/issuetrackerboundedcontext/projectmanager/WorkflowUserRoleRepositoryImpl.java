...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for WorkflowUserRole Master table Entity", complexity = Complexity.LOW)
public class WorkflowUserRoleRepositoryImpl extends SearchInterfaceImpl implements WorkflowUserRoleRepository<WorkflowUserRole> {
    ...
    public List<WorkflowUserRole> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole> query = emanager.createQuery("select u from WorkflowUserRole u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<WorkflowUserRole> save(List<WorkflowUserRole> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<WorkflowUserRole> findByWorkflowId(String workflowId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole> listOfWorkflowUserRole = query.getResultList();
    ...
    public WorkflowUserRole findById(String workUserRoleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole listOfWorkflowUserRole = (issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.WorkflowUserRole) query.getSingleResult();
            return listOfWorkflowUserRole;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
