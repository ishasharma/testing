...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for IssueSeverity Master table Entity", complexity = Complexity.LOW)
public class IssueSeverityRepositoryImpl extends SearchInterfaceImpl implements IssueSeverityRepository<IssueSeverity> {
    ...
    @Override
    @Transactional
    public List<IssueSeverity> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity> query = emanager.createQuery("select u from IssueSeverity u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public IssueSeverity save(IssueSeverity entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<IssueSeverity> save(List<IssueSeverity> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(IssueSeverity entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<IssueSeverity> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity obj = entity.get(i);
    ...
    @Transactional
    public IssueSeverity findById(String issueSeverityCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("IssueSeverity.findById");
            query.setParameter("issueSeverityCode", issueSeverityCode);
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity listOfIssueSeverity = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueSeverity) query.getSingleResult();
            return listOfIssueSeverity;
        } catch (javax.persistence.PersistenceException e) {
