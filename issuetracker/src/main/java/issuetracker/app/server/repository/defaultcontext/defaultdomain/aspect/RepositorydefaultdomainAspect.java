package issuetracker.app.server.repository.defaultcontext.defaultdomain.aspect;
...
@Aspect
@Component
public class RepositorydefaultdomainAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.repository.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.defaultcontext.defaultdomain..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.defaultcontext.defaultdomain..*(..))")
