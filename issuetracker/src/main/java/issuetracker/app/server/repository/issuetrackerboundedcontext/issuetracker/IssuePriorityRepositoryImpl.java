...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for IssuePriority Master table Entity", complexity = Complexity.LOW)
public class IssuePriorityRepositoryImpl extends SearchInterfaceImpl implements IssuePriorityRepository<IssuePriority> {
    ...
    @Override
    @Transactional
    public List<IssuePriority> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority> query = emanager.createQuery("select u from IssuePriority u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public IssuePriority save(IssuePriority entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<IssuePriority> save(List<IssuePriority> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(IssuePriority entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<IssuePriority> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority obj = entity.get(i);
    ...
    @Transactional
    public IssuePriority findById(String issuePriorityCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("IssuePriority.findById");
            query.setParameter("issuePriorityCode", issuePriorityCode);
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority listOfIssuePriority = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssuePriority) query.getSingleResult();
            return listOfIssuePriority;
        } catch (javax.persistence.PersistenceException e) {
