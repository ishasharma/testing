...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for FeatureCategory Master table Entity", complexity = Complexity.LOW)
public class FeatureCategoryRepositoryImpl extends SearchInterfaceImpl implements FeatureCategoryRepository<FeatureCategory> {
    ...
    @Override
    @Transactional
    public List<FeatureCategory> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory> query = emanager.createQuery("select u from FeatureCategory u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public FeatureCategory save(FeatureCategory entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<FeatureCategory> save(List<FeatureCategory> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(FeatureCategory entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<FeatureCategory> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory obj = entity.get(i);
    ...
    @Transactional
    public FeatureCategory findById(String featureCategoryCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("FeatureCategory.findById");
            query.setParameter("featureCategoryCode", featureCategoryCode);
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory listOfFeatureCategory = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory) query.getSingleResult();
            return listOfFeatureCategory;
        } catch (javax.persistence.PersistenceException e) {
