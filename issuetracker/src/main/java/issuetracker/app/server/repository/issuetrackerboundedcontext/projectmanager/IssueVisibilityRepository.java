...
public interface IssueVisibilityRepository<T> extends SearchInterface {
    ...
    public T findById(String issueVisibilityCode) throws Exception, SpartanPersistenceException;
}
