...
public interface FeatureCategoryRepository<T> extends SearchInterface {
    ...
    public T findById(String featureCategoryCode) throws Exception, SpartanPersistenceException;
}
