package issuetracker.app.server.repository.organizationboundedcontext.location.aspect;
...
@Aspect
@Component
public class RepositorylocationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.repository.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.organizationboundedcontext.location..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.organizationboundedcontext.location..*(..))")
