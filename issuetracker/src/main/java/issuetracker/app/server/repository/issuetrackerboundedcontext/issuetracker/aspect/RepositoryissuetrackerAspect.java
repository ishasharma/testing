package issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker.aspect;
...
@Aspect
@Component
public class RepositoryissuetrackerAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* issuetracker.app.server.repository.issuetrackerboundedcontext.issuetracker..*(..))")
