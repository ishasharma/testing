...
public interface IssuePriorityRepository<T> extends SearchInterface {
    ...
    public T findById(String issuePriorityCode) throws Exception, SpartanPersistenceException;
}
