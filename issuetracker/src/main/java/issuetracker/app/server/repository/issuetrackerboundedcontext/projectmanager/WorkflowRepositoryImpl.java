...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for Workflow Master table Entity", complexity = Complexity.LOW)
public class WorkflowRepositoryImpl extends SearchInterfaceImpl implements WorkflowRepository<Workflow> {
    ...
    @Override
    @Transactional
    public List<Workflow> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow> query = emanager.createQuery("select u from Workflow u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Workflow save(Workflow entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Workflow> save(List<Workflow> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Workflow entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Workflow> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow obj = entity.get(i);
    ...
    @Transactional
    public Workflow findById(String workflowId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Workflow.findById");
            query.setParameter("workflowId", workflowId);
            issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow listOfWorkflow = (issuetracker.app.shared.issuetrackerboundedcontext.projectmanager.Workflow) query.getSingleResult();
