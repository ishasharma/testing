...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "Repository for IssueFlag Master table Entity", complexity = Complexity.LOW)
public class IssueFlagRepositoryImpl extends SearchInterfaceImpl implements IssueFlagRepository<IssueFlag> {
    ...
    @Override
    @Transactional
    public List<IssueFlag> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag> query = emanager.createQuery("select u from IssueFlag u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public IssueFlag save(IssueFlag entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<IssueFlag> save(List<IssueFlag> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag s = emanager.find(issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(IssueFlag entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<IssueFlag> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag obj = entity.get(i);
    ...
    @Transactional
    public IssueFlag findById(String issueFlagCode) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("IssueFlag.findById");
            query.setParameter("issueFlagCode", issueFlagCode);
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag listOfIssueFlag = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueFlag) query.getSingleResult();
            return listOfIssueFlag;
        } catch (javax.persistence.PersistenceException e) {
