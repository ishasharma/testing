...
public interface IssueRelationTypeRepository<T> extends SearchInterface {
    ...
    public T findById(String relationCode) throws Exception, SpartanPersistenceException;
}
