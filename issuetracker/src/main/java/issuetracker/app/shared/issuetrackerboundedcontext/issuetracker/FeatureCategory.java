...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "FeatureCategory", complexity = Complexity.LOW)
...
public class FeatureCategory implements Serializable, CommonEntityInterface, Comparator<FeatureCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory other = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.FeatureCategory) obj;
            if (featureCategoryCode == null) {
                return false;
