...
@SourceCodeAuthorClass(createdBy = "root", updatedBy = "", versionNumber = "1", comments = "IssueActivity", complexity = Complexity.LOW)
...
public class IssueActivity implements Serializable, CommonEntityInterface, Comparator<IssueActivity> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueActivity other = (issuetracker.app.shared.issuetrackerboundedcontext.issuetracker.IssueActivity) obj;
            if (issueActivityCode == null) {
                return false;
