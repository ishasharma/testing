...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.aaaboundedcontext.authentication.UserAccessLevel other = (issuetracker.app.shared.aaaboundedcontext.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
