...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.aaaboundedcontext.authentication.PasswordPolicy other = (issuetracker.app.shared.aaaboundedcontext.authentication.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
