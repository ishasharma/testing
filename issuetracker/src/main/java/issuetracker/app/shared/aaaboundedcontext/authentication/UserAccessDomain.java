...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.aaaboundedcontext.authentication.UserAccessDomain other = (issuetracker.app.shared.aaaboundedcontext.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
