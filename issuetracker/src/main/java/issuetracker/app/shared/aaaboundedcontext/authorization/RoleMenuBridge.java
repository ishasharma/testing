...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.aaaboundedcontext.authorization.RoleMenuBridge other = (issuetracker.app.shared.aaaboundedcontext.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
