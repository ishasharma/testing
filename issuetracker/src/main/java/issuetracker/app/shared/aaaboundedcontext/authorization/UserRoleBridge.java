...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.aaaboundedcontext.authorization.UserRoleBridge other = (issuetracker.app.shared.aaaboundedcontext.authorization.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
