...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.organizationboundedcontext.contacts.CommunicationType other = (issuetracker.app.shared.organizationboundedcontext.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
