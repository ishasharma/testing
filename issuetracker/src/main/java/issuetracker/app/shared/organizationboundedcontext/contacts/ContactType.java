...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            issuetracker.app.shared.organizationboundedcontext.contacts.ContactType other = (issuetracker.app.shared.organizationboundedcontext.contacts.ContactType) obj;
            if (contactTypeId == null) {
                return false;
